...
from tacrev_utils import get_example_fields, get_label_id, precision_recall_fscore_exclude_nota, get_relation_set, \
...
def evaluate(model_family, client, model, tokenizer, tacrev_file, n, experiment_name, open_source_api_mode=None):
    sleep = False
    save = False
    ...
    tacrev_path = "../../data/tacrev/"
    with open(tacrev_path + tacrev_file, "r") as f:
