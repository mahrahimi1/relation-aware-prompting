...
def run_eval_tacred(model_family, client, model, tokenizer, experiment_name, synthesize_examples):
...
def main():
    ...
    run_eval_tacred(model_family, client, model, tokenizer, experiment_name, synthesize_examples)
