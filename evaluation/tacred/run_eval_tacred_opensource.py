...
from tacred_utils import Model_Family


def run_eval_tacred(model_family, model, tokenizer, experiment_name, n=None, synthesize_examples=False):
...
def main():
    ...
    # or use any local open source model, for example
    ...
    run_eval_tacred(model_family, model, tokenizer, experiment_name, synthesize_examples=synthesize_examples)
